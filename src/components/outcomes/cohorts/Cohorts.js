                    ...
                    <div class="flex flex-col w-full">
                        <div class="flex flex-wrap sm:flex-row py-2 mb-4 justify-between">
                            <div className="flex flex-col sm:w-1/2 mb-2 sm:mb-0">
                                <h1 class="text-primary text-nunito-semiBold uppercase text-sm">Cohorts</h1>
                            ...
                            <button type="button" class="text-secondary bg-secondary/10 uppercase font-medium rounded-sm text-xs px-4 py-1.5 h-fit text-center inline-flex items-center ">
