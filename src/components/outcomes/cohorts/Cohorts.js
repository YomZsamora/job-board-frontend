            ...
            <div className="flex flex-col h-full">
                 <div className="flex flex-wrap">
                    {/* <div className="md:w-20">
                        <div className="bg-gray-light h-full py-8">
                    ...
                    <div className="md:flex-1">
                        ...
                        <div className="flex flex-wrap px-8 mt-4">
                            <div className="flex flex-col w-full">
                                <div className="flex flex-wrap sm:flex-row py-2 mb-4 justify-between">
                                    <div className="flex flex-col sm:w-1/2 mb-2 sm:mb-0">
                                        <h1 className="text-primary text-nunito-light uppercase text-xl">Cohorts</h1>
                                        <p className="leading-snug text-xs text-nunito-light">19 Cohorts with a total of 568 graduates. Most recent graduation was on April 2022.</p>
                                    </div>
