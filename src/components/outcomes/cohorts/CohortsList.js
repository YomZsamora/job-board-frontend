        ...
        <div >
            <div>
                <div className="flex flex-wrap justify-between mb-2">
                    <div className="flex flex-wrap items-center">
                        ...
                        <div>
                            ...
                            class={`${
                                ...
                                <ul class="py-1 text-sm text-primary">
                                    <li  class="block px-2 py-2 hover:bg-gray-light text-xs cursor-pointer">
                                        No. Of Graduates
                                    </li>
                                    <li  class="block px-2 py-2 hover:bg-gray-light text-xs cursor-pointer">
                                        Graduation Date
                        ...
                        <div>
                            <div class="flex py-1.5 items-center">
                                <div class="flex items-center mr-4">
                                    <input id="inline-checkbox" type="checkbox" value="" class="w-4 h-4 bg-gray-100 rounded border-primary cursor-pointer accent-secondary" checked />
                                    <label for="inline-checkbox" class="ml-2 text-xs text-nunito-light text-primary">Software Development</label>
                                </div>
                                <div class="flex items-center mr-4">
                                    <input id="inline-2-checkbox" type="checkbox" value="" class="w-4 h-4 bg-gray-100 rounded border-primary cursor-pointer accent-secondary" checked />
                                    <label for="inline-2-checkbox" class="ml-2 text-xs text-nunito-light text-primary">Data Science</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <button type="button" class="text-alert-success-dark bg-alert-success-light uppercase text-nunito-light rounded-sm text-xs px-4 py-1.5 h-fit text-center inline-flex items-center ">
             ...
             <div class="flex flex-row relative border-b border-gray-light w-full overflow-x-auto items-center">
                <button type="button" class="flex sticky top-0 left-0 z-10 justify-center items-center px-4 h-full cursor-pointer group focus:outline-none">
                ...
                <button type="button" class="flex sticky top-0 right-0 z-10 justify-center items-center px-4 h-full cursor-pointer group focus:outline-none">
                    <span class="inline-flex justify-center items-center w-6 h-6 rounded-full sm:w-10 sm:h-10 bg-gray-light group-hover:text-secondary ">
