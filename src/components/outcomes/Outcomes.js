        ...
        <div>
            ...
            <aside class="w-64" aria-label="Sidebar">
                <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
                    ...
                    <ul class="space-y-2 border-b border-primary/20">
                        <li>
                            <a href="#" class="flex items-center p-2 text-base font-normal text-primary rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700">
